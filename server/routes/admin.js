...
const { BookValidation, FetchBookValidation } = BookValidator;
...
admin.get('/admin/lendinghistory', verifyToken, authorizeUser(['superadmin', 'admin']), FetchBookValidation(), getBorrowingStats);
